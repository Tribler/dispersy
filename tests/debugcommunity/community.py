    ...
    def initiate_meta_messages(self):
        ...
        messages.extend([
            ...
            Message(self, "last-9-test",
                    ...
                    self._generic_timeline_check,
                    self.on_text),
                Message(self, "last-1-doublemember-text",
                ...
                Message(self, "double-signed-text",
                        ...
                        self._generic_timeline_check,
                        self.on_text),
                Message(self, "double-signed-text-split",
                ...
                Message(self, "full-sync-text",
                        MemberAuthentication(),
                        PublicResolution(),
                        FullSyncDistribution(enable_sequence_number=False, synchronization_direction="ASC", priority=128),
                        CommunityDestination(node_count=10),
                        TextPayload(),
                        self._generic_timeline_check,
                        self.on_text,
                        self.undo_text),
                Message(self, "n-hop-sync-text",
                        MemberAuthentication(),
                        PublicResolution(),
                        FullSyncDistribution(enable_sequence_number=False, synchronization_direction="ASC", priority=128),
                ...
                Message(self, "ASC-text",
                        ...
                        self._generic_timeline_check,
                        self.on_text),
                Message(self, "DESC-text", MemberAuthentication(),
                        PublicResolution(),
                        FullSyncDistribution(enable_sequence_number=False, synchronization_direction="DESC", priority=128),
                        CommunityDestination(node_count=10),
                        TextPayload(),
                        self._generic_timeline_check,
                        self.on_text),
                ...
                Message(self, "sequence-text",
                        ...
                        self.on_text,
                        self.undo_text),
                Message(self, "full-sync-global-time-pruning-text",
                        MemberAuthentication(),
                        PublicResolution(),
                        FullSyncDistribution(enable_sequence_number=False, synchronization_direction="ASC", priority=128, pruning=GlobalTimePruning(10, 20)),
                        CommunityDestination(node_count=10),
                        TextPayload(),
                        self._generic_timeline_check,
                        self.on_text,
                        self.undo_text),
                Message(self, "high-priority-text",
                        MemberAuthentication(),
                        PublicResolution(),
                        FullSyncDistribution(enable_sequence_number=False, synchronization_direction="ASC", priority=200),
                        CommunityDestination(node_count=10),
                        TextPayload(),
                        self._generic_timeline_check,
                        self.on_text),
                Message(self, "low-priority-text",
                        MemberAuthentication(),
                        PublicResolution(),
                        FullSyncDistribution(enable_sequence_number=False, synchronization_direction="ASC", priority=100),
                        CommunityDestination(node_count=10),
                        TextPayload(),
                        self._generic_timeline_check,
                        self.on_text),
                Message(self, "medium-priority-text",
                        MemberAuthentication(),
                        PublicResolution(),
                        FullSyncDistribution(enable_sequence_number=False, synchronization_direction="ASC", priority=150),
                        CommunityDestination(node_count=10),
                        TextPayload(),
                        self._generic_timeline_check,
                        self.on_text),
                Message(self, "RANDOM-text",
                        MemberAuthentication(),
                        PublicResolution(),
                        FullSyncDistribution(enable_sequence_number=False, synchronization_direction="RANDOM", priority=128),
                        CommunityDestination(node_count=10),
                        TextPayload(),
                        self._generic_timeline_check,
                        self.on_text),
                Message(self, "batched-text",
                        MemberAuthentication(),
                        PublicResolution(),
                        FullSyncDistribution(enable_sequence_number=False, synchronization_direction="ASC", priority=128),
                        CommunityDestination(node_count=10),
